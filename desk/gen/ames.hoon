::  +diagnose!ames: is your %ames healthy?
::
=>  |%
    ...
    ::
    ::    %0: TODO
    ::    %1: flows from nacking initial subscriptions
    ::    %2: stale flows that keep (re)trying to connect
    ::   %21: stale flows that keep (re)trying to connect, per app (forward)
    ::    %3: stale resubscriptions
    ::   %31: stale resubscriptions, per app TODO
    ::
    +$  veb  ?(%0 %1 %2 %21 %3 %31)
    ::
    ++  resubs
